   ...
   <tbody>
      ...
      ?>
        <tr>
          ...
          <td style="text-align: center"><div align="center"><span><?php echo $datos[$i]["producto_pedido"]; ?></span></div></td>
          <td style="text-align: center"><div align="center"><span><?php echo $datos[$i]["cantidad_pedido"]; ?></span></div></td>
          <td style="text-align: center"><div align="center"><span><?php echo $datos[$i]["cuit_proveedor"]; ?></span></div></td>
          <td style="text-align: center"><div align="center"><span><?php echo Conectar::invierte_fecha($datos[$i]["fecha_pedido"]) ?></span></div></td>
        </tr>
      <?php } ?>
...
$mpdf->Output('InformePedidos.pdf','I'); //muestra a usuario
