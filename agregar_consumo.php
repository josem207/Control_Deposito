<?php
  ...
  if(isset($_SESSION["backend_id"])){
    ...
    $cod_consumo=new Consumo();

    if(isset($_POST["grabar"]) and $_POST["grabar"]=="si"){

      $cod_consumo->agregar_consumo();
...
<head>
 ...
 <div class="page-header"> <!-- panel usuario --> 
    <nav class="navbar">  
       <a class="navbar-brand" href="#">Registro de nuevo consumo</a>
    </nav>
 </div><!--fin page-header-->
        ...
        <div class="block">
                       ...
                       if(isset($_GET["m"])){
                         switch($_GET["m"]){
                          ...
                          <div class="alert alert-danger" role="alert">los campos estan vacios?</div>                 
                           ...
                           case "2";
                           ?> 
                           <div class="alert alert-success" role="alert">consumo de stock registrado!</div>
                          <?php
                           break;
                         }
                       }
          ?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                       <input type="text" name="cantidad_consumo" class="form-control form-control-success" placeholder="Ingrese cantidad">
                    </div>
                  </div>
